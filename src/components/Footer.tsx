        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-[520px] max-h-[90vh] overflow-auto border border-[#27272a] bg-[#0f0f10] rounded-[12px] overflow-hidden">
            <div className="flex items-center justify-between border-b border-[#27272a] bg-[#18181b] px-4 py-3">
              <span className="text-[11px] font-mono tracking-widest text-zinc-400">{lang === "pl" ? "WESPRZYJ — WYBIERZ METODĘ" : "SUPPORT — CHOOSE METHOD"}</span>
              <button onClick={() => setOpen(false)} className="text-zinc-500 hover:text-white text-[18px] leading-none px-1">×</button>
            </div>
            <div className="grid gap-2.5 p-3">
              <a href="https://donate.stripe.com/8x25kDdyA72LdWo7SEao800" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center border border-[#27272a] bg-[#09090b] hover:border-[#8b5cf6]/40 hover:bg-[#18181b] py-5 px-3 transition-colors group">
                <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap w-full">
                  <span className="inline-flex items-center justify-center rounded-[10px] bg-white px-5 py-2 h-[46px] flex-1 min-w-[92px] max-w-[120px]"><span className="text-[18px] font-bold tracking-tight text-black leading-none"> Pay</span></span>
                  <span className="inline-flex items-center justify-center rounded-[10px] bg-white px-5 py-2 h-[46px] flex-1 min-w-[92px] max-w-[120px] gap-0.5"><span className="text-[18px] font-bold tracking-tight leading-none"><span className="text-[#4285F4]">G</span><span className="text-black"> Pay</span></span></span>
                  <span className="inline-flex items-center justify-center rounded-[10px] bg-white px-5 py-2 h-[46px] flex-1 min-w-[92px] max-w-[120px]"><span className="text-[16px] font-black tracking-tighter text-black leading-none">BLIK</span></span>
                  <span className="inline-flex items-center justify-center rounded-[10px] bg-white px-4 py-2 h-[46px] flex-1 min-w-[92px] max-w-[120px]"><svg width="28" height="18" viewBox="0 0 20 14" fill="none" className="shrink-0"><rect x="0.5" y="0.5" width="19" height="13" rx="2" stroke="black" strokeOpacity="0.15" /><rect x="1" y="4.5" width="18" height="3" fill="black" /><rect x="2.5" y="9.8" width="6" height="3" rx="0.7" fill="black" fillOpacity="0.12" /></svg></span>
                </div>
              </a>
              <a href="https://paypal.me/OlivierLehner2006" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center border border-[#27272a] bg-[#09090b] hover:border-[#8b5cf6]/40 hover:bg-[#18181b] py-5 px-3 transition-colors group"><span className="inline-flex items-center justify-center rounded-[10px] bg-white px-8 py-2 h-[46px] w-full max-w-[260px]"><span className="text-[18px] font-bold italic tracking-tight leading-none"><span className="text-[#003087]">Pay</span><span className="text-[#009CDE]">Pal</span></span></span></a>
              <p className="text-[10px] font-mono leading-relaxed text-zinc-600 px-1 text-center">{lang === "pl" ? "Dzięki za wsparcie! c:" : "Thanks for your support! c:"}</p>
            </div>
          </div>
        </div>
      )}
